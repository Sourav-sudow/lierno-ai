...
async def send_otp(request: EmailRequest):
    ...
    college_domains = ["@krmu.edu.in", "@student.college.edu", "@edu.in"]
    if not any(email.endswith(domain) for domain in college_domains):
        raise HTTPException(status_code=400, detail="Please use a valid college email")
